...
The bottom $~40pix$ rows of the detectors are physically blocked from receiving light. When \verb!--subtract_nolight_rows=TRUE! then the DRS will 

With \verb!--subtract_interorder_column=TRUE! given, recipes

The latter has given good results in tests and is therefore turned on by
