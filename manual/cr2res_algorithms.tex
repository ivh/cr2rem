...
If \verb!NDIT >1!, then a factor of $\sqrt{\verb!NDIT!}$ needs to be taken into
account manually, because the sub-exposures were averaged in the detector
software, which does not affect the ADU level.

This section will be expanded in the next release of this document.
