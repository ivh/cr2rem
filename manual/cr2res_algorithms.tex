...
However, because non-poissonian noise like cosmic rays affects the residual
between data and model more than the spectrum itself, the error spectrum can be
overly pessimistic (cf.~\ref{sec:erroroverest}).

In order to compare this S/N with the theoretical expectation from
