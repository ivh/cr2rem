...
Users are generally provided with the static calibration data-product
...
\putgraph{.8\linewidth}{detlin_corrfacs.png}{detlincorrfac}{The size of the non-linearity correction, depending on raw ADU-level.}
