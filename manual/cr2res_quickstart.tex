...
experimental and quality not ensure to be "science-ready".
...
products like the TW. This is also the way the CalibDB is being assembled. The following gives example SOFs and recipe calls to reduce a single setting.
