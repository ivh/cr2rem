...
upper edge of the trace, so that a trace the full slit has 
\verb!SlitFraction=[0.0,0.5,1.0]!
...
polynomials from the TW table outside the of the DRS.
...
hand are run to create the output data products.
