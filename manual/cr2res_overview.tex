...
\begin{figure}[!tb]
  \begin{center}
    \psfig{file=figures/fits_ext.pdf,width=0.99\linewidth}
  \end{center}
  \caption{
    \label{fig:fits_ext}
    .}
...
The basic characteristics of the data that we need to characterize are the following
\begin{enumerate}
    \item Detector linearity
    \item Dark current
    \item Bad Pixel Map
...
The results of steps 1,2,3 and 5 are stored as separate master calibrations, respectively. Information about the orders 4,5,7 are stored together in a TW-table, as described in more detail %TODO ref.
